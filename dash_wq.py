...
Original file is located at
    https://colab.research.google.com/drive/1Ei5kubCC2C_bdCMgFVJmmrA-rLsX235y
"""
...
usuario = "JCH-01"
repo = "Dashboard-Calidad-Vino"
token = getpass.getpass("Introduce tu token GitHub:")

url = f"https://{usuario}:{token}@github.com/{usuario}/{repo}.git"

!git config --global user.email "jchepote5412@gmail.com"
!git config --global user.name "JCH-01"

!git clone {url}
# %cd {repo}

# Crear un archivo de prueba
with open("Dash_WQ.ipynb", "w") as f:
    f.write("Este archivo fue creado desde Colab")

# Hacer push
!git add .
!git commit -m "Prueba desde Google Colab"
